...
| **Çözüm** | Tam sürümleri bağımlılık kısıtlamalar paketlerle sürüm gerekirse artırmak diğer paketleri izin vermez. Gerekli tam sürümüyle paketi doğrudan (proje dosyası) bir başvuru ekleyin. |
