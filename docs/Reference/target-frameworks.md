...
- [.nuspec bildirimi](../reference/nuspec.md): bir paket projenin hedef çerçevesi bağlı olarak bir projeye dahil edilecek ayrı paketleri belirtebilirsiniz.
...
- [Packages.config](../reference/packages-config.md): `targetframework` bir bağımlılık özniteliğinin yüklemek için bir paket türevi belirtir.
...
|                |              | net461     |
|                |              | net462     |
|Microsoft deposu (Windows mağazası) | netcore      | netcore [netcore45] |
...
| Profil # | çerçeveler | Tam ad | .NET Standard |
 --- | --- | --- | ---
