...
## <a name="specify-packages-folder-location"></a><span data-ttu-id="2c6dc-121">'Packages' klasörü konumu belirtin</span><span class="sxs-lookup"><span data-stu-id="2c6dc-121">Specify ‘packages’ Folder Location</span></span>
