...
1. Unutmayın **preprelease dahil** ve **paket kaynağı** denetimleri etkisiz paketleri kaldırırken.
...
Bu örnekte, ConsoleApp1 EntityFramework 6.2.0 kullanıyor ancak ClassLibrary1 projesindeki EntityFramework 6.2.0, kullanıyor. Paket sürümlerinin birleştirmek için aşağıdakileri yapın:
...
**Zorla kaldırın olsa bile bağımlılıklar üzerinde**: projede başvuruluyor olsa bile, seçili olduğunda, bir paketi kaldırır. Bu genellikle ile birlikte kullanılır **kaldırmak bağımlılıkları** ve her bir paketi kaldırmak için yüklü bağımlılıkları. Bu seçeneği kullanarak ancak bozuk başvurularda projesinde açabilir. Böyle durumlarda, gerekebilir [bu diğer paketleri yeniden](../consume-packages/reinstalling-and-updating-packages.md).
