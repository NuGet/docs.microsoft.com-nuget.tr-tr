### <a name="priority-ordering"></a><span data-ttu-id="3d6c2-101">Öncelik sırası</span><span class="sxs-lookup"><span data-stu-id="3d6c2-101">Priority ordering</span></span>
