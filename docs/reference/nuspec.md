...
## <a name="general-form-and-schema"></a><span data-ttu-id="9be67-116">Genel form ve şema</span><span class="sxs-lookup"><span data-stu-id="9be67-116">General form and schema</span></span>
...
<span data-ttu-id="9be67-125">Bu öğeleri içinde görünmelidir bir `<metadata>` öğesi.</span><span class="sxs-lookup"><span data-stu-id="9be67-125">These elements must appear within a `<metadata>` element.</span></span>
...
#### <a name="title"></a><span data-ttu-id="9be67-138">Başlık</span><span class="sxs-lookup"><span data-stu-id="9be67-138">title</span></span>
...
#### <a name="iconurl"></a><span data-ttu-id="9be67-159">IconUrl</span><span class="sxs-lookup"><span data-stu-id="9be67-159">iconUrl</span></span>
...
#### <a name="language"></a><span data-ttu-id="9be67-176">dil</span><span class="sxs-lookup"><span data-stu-id="9be67-176">language</span></span>
...
| <span data-ttu-id="9be67-247">**$description$**</span><span class="sxs-lookup"><span data-stu-id="9be67-247">**$description$**</span></span> | <span data-ttu-id="9be67-248">AssemblyInfo</span><span class="sxs-lookup"><span data-stu-id="9be67-248">AssemblyInfo</span></span> | <span data-ttu-id="9be67-249">AssemblyDescription</span><span class="sxs-lookup"><span data-stu-id="9be67-249">AssemblyDescription</span></span> |
...
| <span data-ttu-id="9be67-269">include</span><span class="sxs-lookup"><span data-stu-id="9be67-269">include</span></span> | <span data-ttu-id="9be67-270">İçerme/dışlama virgülle ayrılmış listesi (aşağıya bakın) son pakette eklenecek bağımlılığın gösteren etiketler.</span><span class="sxs-lookup"><span data-stu-id="9be67-270">A comma-delimited list of include/exclude tags (see below) indicating of the dependency to include in the final package.</span></span> <span data-ttu-id="9be67-271">Varsayılan değer `all` şeklindedir.</span><span class="sxs-lookup"><span data-stu-id="9be67-271">The default value is `all`.</span></span> |
...
<span data-ttu-id="9be67-390">*NuGet 4.0 + PackageReference ile*</span><span class="sxs-lookup"><span data-stu-id="9be67-390">*NuGet 4.0+ with PackageReference*</span></span>
...
## <a name="example-nuspec-files"></a><span data-ttu-id="9be67-424">Örneğin nuspec dosyaları</span><span class="sxs-lookup"><span data-stu-id="9be67-424">Example nuspec files</span></span>

<span data-ttu-id="9be67-425">**Basit bir `.nuspec` , bağımlılıklar veya dosyaları belirtmiyor**</span><span class="sxs-lookup"><span data-stu-id="9be67-425">**A simple `.nuspec` that does not specify dependencies or files**</span></span>
...
<span data-ttu-id="9be67-426">**A `.nuspec` bağımlılıklar**</span><span class="sxs-lookup"><span data-stu-id="9be67-426">**A `.nuspec` with dependencies**</span></span>
...
<span data-ttu-id="9be67-427">**A `.nuspec` dosyaları**</span><span class="sxs-lookup"><span data-stu-id="9be67-427">**A `.nuspec` with files**</span></span>
...
<span data-ttu-id="9be67-428">**A `.nuspec` framework derlemeleri ile**</span><span class="sxs-lookup"><span data-stu-id="9be67-428">**A `.nuspec` with framework assemblies**</span></span>
...
<span data-ttu-id="9be67-429">Bu örnekte, belirli proje hedefleri aşağıdaki yüklenir:</span><span class="sxs-lookup"><span data-stu-id="9be67-429">In this example, the following are installed for specific project targets:</span></span>

- <span data-ttu-id="9be67-430">. NET4 -&GT; `System.Web`, `System.Net`</span><span class="sxs-lookup"><span data-stu-id="9be67-430">.NET4 -> `System.Web`, `System.Net`</span></span>
- <span data-ttu-id="9be67-431">. NET4 İstemci profili -> `System.Net`</span><span class="sxs-lookup"><span data-stu-id="9be67-431">.NET4 Client Profile -> `System.Net`</span></span>
- <span data-ttu-id="9be67-432">Silverlight 3 -> `System.Json`</span><span class="sxs-lookup"><span data-stu-id="9be67-432">Silverlight 3 -> `System.Json`</span></span>
- <span data-ttu-id="9be67-433">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span><span class="sxs-lookup"><span data-stu-id="9be67-433">Silverlight 4 -> `System.Windows.Controls.DomainServices`</span></span>
- <span data-ttu-id="9be67-434">WindowsPhone -> `Microsoft.Devices.Sensors`</span><span class="sxs-lookup"><span data-stu-id="9be67-434">WindowsPhone -> `Microsoft.Devices.Sensors`</span></span>
