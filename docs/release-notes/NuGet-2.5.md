...
Her zaman en çok istenen özelliklerden biri, bir NuGet paketi eklendiğinde diskte zaten içerik dosyalarının üzerine özelliği kaldırıldı. NuGet 2.5 ile başlayarak, bu çakışmaları tanımlanır ve daha önce bu dosyaları her zaman Atlanan ancak dosyaların üzerine istenir.
