...
### <a name="msbuild-trestore-fails-when-a-project-targeting-net461-references-another-project-targeting-netstandard"></a>`msbuild /t:restore`bir proje hedeflerken başarısız olur. Başka bir proje hedefleme NET461 başvurur. NETStandard
