1. <span data-ttu-id="2cbea-101">Değiştirmek için içeren klasör `.nupkg` dosya.</span><span class="sxs-lookup"><span data-stu-id="2cbea-101">Change to the folder containing the `.nupkg` file.</span></span>
